package br.com.gestao.financeira.api.domain.port;


import br.com.gestao.financeira.api.domain.model.TipoTransacao;
import br.com.gestao.financeira.api.dto.*;
...
public interface TransacaoRepository extends JpaRepository<Transacao, Long> {
    ...
    @Query("""
                select new br.com.gestao.financeira.api.dto.DadosListagemTransacao(
    ...
    @Query("""
                select new br.com.gestao.financeira.api.dto.DadosResumoCategoria(
                    t.tipoTransacao,
                    sum(t.valor)
                )
                from Transacao t
    ...
    @Query("""
                select new br.com.gestao.financeira.api.dto.DadosResumoMensal(
